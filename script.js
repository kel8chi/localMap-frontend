class MapManager {
  constructor() {
    ...
    this.isAdmin = true;
    this.nextId = 12; // Start after wema.json's last ID
    ...
    // Define category-specific SVG pin icons with beeping animation
      ...
      acc[category] = L.divIcon({
        ...
        html: `
          <svg width="30" height="45" viewBox="0 0 30 45" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 0C6.716 0 0 6.716 0 15c0 3.5 1.2 6.8 3.3 9.5L15 45l11.7-20.5c2.1-2.7 3.3-6 3.3-9.5C30 6.716 23.284 0 15 0z" fill="${this.styles[category].color}" stroke="#000" stroke-width="1"/>
            <circle cx="15" cy="15" r="6" fill="white" stroke="#000" stroke-width="1"/>
          </svg>
        `,
        iconSize: [30, 45],
        iconAnchor: [15, 45],
  ...
  initializeEventListeners() {
    document.getElementById('toggleSidebar').addEventListener('click', () => {
      ...
      document.getElementById('toggleSidebar').textContent = isCollapsed ? 'Expand Sidebar' : 'Collapse Sidebar';
      document.getElementById('toggleSidebar').setAttribute('aria-expanded', !isCollapsed);
    });
